...
int checkPlayers(char py1, char py2)
{
    ...
    if ((py1 == 's' || py1 == 'S') && (py2 == 'w' || py2 == 'W'))
    {
        return 1;
    }

    if ((py1 == 'w' || py1 == 'W') && (py2 == 'g' || py2 == 'G'))
    {
        return 1;
    }

    if ((py1 == 'g' || py1 == 'G') && (py2 == 's' || py2 == 'S'))
    {
        return 1;
    }
    else
...
int checkCompAndPlayer(char cp, char py)
{
    ...
    if ((cp == 's' || cp == 'S') && (py == 'w' || py == 'W'))
    {
        return 1;
    }

    if ((cp == 'w' || cp == 'W') && (py == 'g' || py == 'G'))
    {
        return 1;
    }

    if ((cp == 'g' || cp == 'G') && (py == 's' || py == 'S'))
    {
        return 1;
    }
    else
...
int main()
{
    ...
    printf("\n************ Ultimate Snake Water Gun Game *********\n");
    printf("***************** Let's see who wins ***************\n\n");
    printf("Rules to remember:-\n");
    printf("1. Type s or S --> Snake\n");
    printf("2. Type g or G --> Gun\n");
    printf("3. Type w or W --> Water\n");
